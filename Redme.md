...
* **Solution:** Conducted an **end-to-end retail analytics project**—from data cleaning and transformation to exploratory analysis and customer segmentation, culminating in an interactive Tableau dashboard.
* **Key Results:**
...
* Supporting assets:
  ...
  * Looker Dashboard (visualizing customer behavior, pack size, and brand preferences)
...
6. **Visualization** – built Tableau dashboard with KPIs, time trends, and preferences.
...
```
├── data/                # Raw transaction & customer data
├── notebooks/           # R scripts for cleaning & analysis
├── dashboards/          # Tableau workbook & exports
├── src/                 # Feature engineering scripts
...
* FMCG Industry Insights – Deloitte Retail Trends Report
* Project Repository: [d-s007.github.io/Quantium\_Retail\_Strategy\_and\_Analytics](https://d-s007.github.io/Quantium_Retail_Strategy_and_Analytics/)